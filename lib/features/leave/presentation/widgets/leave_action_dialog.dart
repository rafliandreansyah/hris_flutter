...
/// Modal dialog konfirmasi untuk menyetujui atau menolak pengajuan cuti
/// dilengkapi input catatan approver (*approverNotes*).
class LeaveActionDialog extends StatefulWidget {
  final bool isApproved;

  const LeaveActionDialog({super.key, required this.isApproved});

  static Future<String?> show(BuildContext context, {required bool isApproved}) {
    return showDialog<String>(
      context: context,
      builder: (context) => LeaveActionDialog(isApproved: isApproved),
    );
  }
...
class _LeaveActionDialogState extends State<LeaveActionDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final titleText =
        widget.isApproved ? 'Setujui Pengajuan Cuti' : 'Tolak Pengajuan Cuti';
    final descText = widget.isApproved
        ? 'Apakah Anda yakin ingin menyetujui pengajuan cuti ini? Anda dapat menyertakan catatan (opsional).'
        : 'Apakah Anda yakin ingin menolak pengajuan cuti ini? Anda dapat menyertakan alasan penolakan.';
