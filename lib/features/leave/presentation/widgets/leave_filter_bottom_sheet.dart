...
class LeaveFilterCriteria extends Equatable {
  ...
  static LeaveFilterCriteria fromAppData(AppRequestFilterData data) {
    return LeaveFilterCriteria(
...
Future<LeaveFilterCriteria?> showLeaveFilterBottomSheet(
  ...
  return LeaveFilterCriteria.fromAppData(result);
}

/// Widget Filter Pengajuan Cuti yang mendelegasikan ke [AppRequestFilterBottomSheet].
